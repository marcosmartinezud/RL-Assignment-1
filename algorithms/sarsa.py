...
# main SARSA training function
def train_sarsa(env, n_episodes: int = 2000, alpha: float = 0.1, gamma: float = 0.99, epsilon: float = 0.1,
    ...
    if seed is not None:
        np.random.seed(seed)  # so results are reproducible
    ...
    for ep in iterator:
        ...
        # show something every 100 episodes
